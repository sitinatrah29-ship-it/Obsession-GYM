    ...
    <div className="relative h-screen flex items-center overflow-hidden bg-gray-950">
      ...
      <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="max-w-3xl">
          ...
          <p className="text-xl text-gray-200 mb-10 max-w-lg leading-relaxed font-semibold drop-shadow-md">
            World-class equipment. Elite coaching. A community of high-performers. Forge your ultimate self at Obsession GYM.
          </p>
          <div className="flex flex-col sm:flex-row gap-4">
            <a 
              href="#contact" 
              className="px-10 py-4 bg-brand-primary hover:bg-red-700 text-white text-lg font-black uppercase tracking-widest transition-all text-center rounded-sm shadow-2xl shadow-brand-primary/20"
            >
              Start Free Trial
            </a>
            <a 
              href="#plans" 
              className="px-10 py-4 bg-white/10 hover:bg-white/20 text-white text-lg font-black uppercase tracking-widest transition-all text-center backdrop-blur-md border border-white/20 rounded-sm"
            >
              Our Plans
            </a>
          </div>
